...
if df_anterior is None or df_anterior.empty:
    ...
    try:
        fig = generate_comparison_chart(datos, df_anterior, metrica_sel)
        if fig:
    ...
    with col1:
        ...
        try:
            df_comp = get_comparison_table(datos, df_anterior, metrica_sel)
    ...
    with col2:
        ...
        try:
            df_month = get_monthly_detail_table(datos, df_anterior, metrica_sel)
